...
namespace MVC5Course.Helpers.ValidationAttributes
{
    /// <summary>
    /// 驗證身份證字號
    /// </summary>
    public class IdNumberCheckAttribute : DataTypeAttribute
    {
        public IdNumberCheckAttribute() : base(DataType.Text)
        {
